# File Konfigurasi Verifikasi Mahasiswa SheerID (Gemini)
# Lokasi: /one/config.py
...
# Masukkan Residential Proxy di sini.
# Format: "http://username:password@ip:port"
# Jika kosong, bot akan menggunakan IP VPS (Rawan Ditolak).
PROXY_URL = "" 
# ---------------------------------------
...
# Daftar Kampus - Pennsylvania State University (PSU) Multi-Kampus
SCHOOLS = {
    '2565': {
        'id': 2565,
        'idExtended': '2565',
...
# Parameter UTM (Untuk Marketing Tracking)
# Akan otomatis ditambahkan jika URL kosong
DEFAULT_UTM_PARAMS = {
    'utm_source': 'gemini',
