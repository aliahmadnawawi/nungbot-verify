"""
Module for Generating PSU Student ID (LionPATH Screenshot)
Used for Spotify Student Verification
"""
import random
...
def generate_psu_id():
    """Generate Random PSU ID (9 digits starting with 9)"""
...
def generate_psu_email(first_name, last_name):
    """
    Generate PSU Email
    Format: firstName.lastName + 3-4 random digits @psu.edu
    """
...
def generate_html(first_name, last_name, school_id='2565'):
    ...
    Args:
        ...
        last_name: Last Name
        school_id: School ID (Default: Main Campus)
    ...
    # Current date and time (US Format)
    ...
    # HTML Template for LionPATH Portal 
    html = f"""<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
...
def generate_image(first_name, last_name, school_id='2565'):
    ...
    try:
        ...
        # 2. Use Playwright to take a screenshot
        with sync_playwright() as p:
            ...
            # Wait a bit for styles to render properly
...
if __name__ == '__main__':
    ...
    # Fix Windows Console Encoding (Just in case)
