# File Konfigurasi Verifikasi Spotify Student
# Lokasi: /spotify/config.py

# Konfigurasi API SheerID (Program ID Spotify Student)
PROGRAM_ID = '67c8c14f5f17a83b745e3f82' # ID Umum (Bisa diganti jika ada update)
...
# Spotify Student biasanya menerima PSU dengan mudah
SCHOOLS = {
    '2565': {
        'id': 2565,
        'idExtended': '2565',
