# File Konfigurasi Verifikasi YouTube Student (Premium)
# Lokasi: /youtube/config.py

# Konfigurasi API SheerID (Program ID YouTube Student)
# ID ini khusus untuk YouTube Premium Student
PROGRAM_ID = '5f20660609b7e716949359e9' 
SHEERID_BASE_URL = 'https://services.sheerid.com'
MY_SHEERID_URL = 'https://my.sheerid.com'

# --- KONFIGURASI PROXY (WAJIB DIISI) ---
# Masukkan Residential Proxy di sini agar tidak kena Fraud Reject.
# Format: "http://username:password@ip:port"
# Jika dibiarkan kosong (""), bot akan menggunakan IP VPS.
PROXY_URL = "" 
# ---------------------------------------
...
# Daftar Kampus - Menggunakan Data PSU (Pennsylvania State University)
# YouTube Student juga menerima PSU dengan mudah
SCHOOLS = {
    '2565': {
        'id': 2565,
        'idExtended': '2565',
