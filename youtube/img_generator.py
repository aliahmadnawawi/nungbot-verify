"""
Modul Generator Kartu Mahasiswa PNG - Penn State LionPATH
Digunakan untuk Verifikasi YouTube Student
"""
import random
...
def generate_psu_email(first_name, last_name):
    """
    Generate Email PSU
    Format: nama.depan.nama.belakang + 3-4 angka acak @psu.edu
    """
...
def generate_html(first_name, last_name, school_id='2565'):
    """
    Generate Konten HTML Penn State LionPATH
    ...
    # Format tanggal US (Bulan/Hari/Tahun)
    ...
    # Template HTML yang meniru tampilan LionPATH 
    html = f"""<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
...
def generate_image(first_name, last_name, school_id='2565'):
    ...
    try:
        ...
        # 2. Gunakan Playwright untuk screenshot
        with sync_playwright() as p:
            ...
            # Tunggu sebentar agar CSS merender sempurna
...
if __name__ == '__main__':
    ...
    # Fix encoding console Windows (jaga-jaga)
    ...
    try:
        ...
        # Simpan gambar test
        with open('test_psu_card_youtube.png', 'wb') as f:
            f.write(img_data)

        print(f"✓ Gambar berhasil dibuat! Ukuran: {len(img_data)} bytes")
        print("✓ Disimpan sebagai test_psu_card_youtube.png")
