# File Konfigurasi Verifikasi Bolt.new (Teacher)
# Lokasi: /Boltnew/config.py
...
# Daftar Sekolah - Menggunakan Data PSU (Pennsylvania State University)
# Bot akan berpura-pura menjadi Guru di kampus ini
SCHOOLS = {
    '2565': {
        'id': 2565,
        'idExtended': '2565',
...
# Parameter UTM (Tracking Marketing)
DEFAULT_UTM_PARAMS = {
    'utm_source': 'gemini',
