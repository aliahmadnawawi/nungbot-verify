...
class NameGenerator:
    ...
    # Suku kata untuk menyusun nama (JANGAN DIUBAH agar tetap terdengar seperti nama Bule)
    ROOTS = {
    ...
    def _format_name(cls, name):
        """Format nama (Huruf pertama Besar)"""
...
def generate_email():
    """
    Membuat email acak (Email umum untuk guru)
...
def generate_birth_date():
    """
    Membuat tanggal lahir acak (Rentang umur guru 1970-1990)
